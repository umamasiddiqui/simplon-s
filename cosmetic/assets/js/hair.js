$(document).ready(function () {
    $.getJSON("assets/js/hair.json", function (data) {
        var productContainer = $("#product-container");

        data.hair_products.forEach(category => {
            // Add category title
                ...
                let productCard = `
                    <div class="col">
                        <div class="card h-100">
                            <img src="assets/images/${product.imag}" class="card-img-top" alt="${product.name}">
                            <div class="card-body">
                                ...
                                <p class="card-description">${product.description}</p>
                                 <a href="javascript:void(0);" onclick="addToCart('${product.id}', '${product.name}', '${product.price}', 'assets/images/${product.imag}')">
